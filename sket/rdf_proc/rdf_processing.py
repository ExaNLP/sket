...
class RDFProc(object):
	...
	@staticmethod
	def associate_polyp2dysplasia(outcomes, mask_outcomes):  # @smarchesin TODO: needs to be part of a dict of functions that are use-case dependants
		"""
	...
	def radboud_create_graph(self, rid, report_data, report_concepts, onto_proc, use_case):  # @smarchesin TODO: what about patient?
		"""
